...
- [Concurrency Patterns]({{ site.baseurl }}/concurrency)
  ...
  - [Parallel Computing Patterns]({{ site.baseurl }}/parallel-computing)
    ...
    - [ErrGroup]({{ site.baseurl }}/parallel-computing/error-group)
  - [Delayed Computing Patterns]({{ site.baseurl }}/delayed-computing)
    - [Future]({{ site.baseurl }}/delayed-computing/future)
