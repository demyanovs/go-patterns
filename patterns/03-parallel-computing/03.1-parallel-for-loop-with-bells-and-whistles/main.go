...
/**
Пример:
Получаем батч данных и с ним нужно сходить во внещние api. Каждый элемен данных не зависит от других и
мы можем отправить параллельные запросы. Можно добавить рейт-лимитер.
*/
